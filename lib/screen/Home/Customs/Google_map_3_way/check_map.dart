...
class Google_map_web extends StatefulWidget {
  const Google_map_web({
    super.key,
  ...
  @override
  State<Google_map_web> createState() => _SearchPlacesScreenState();
}
...
class _SearchPlacesScreenState extends State<Google_map_web> {
  String sendAddrress = '';
